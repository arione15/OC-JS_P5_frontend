...
/* Cette fonction permet de stocker les identifiants des cameras ajoutées au panier dans le navigateur (localStorage). Il faut stocker le id ET la lentille pour avoir un produit unique, sinon si j'ajoute une camera avec une lentille je ne pourrais plus rajouter la même camer avec une lentille différente !!! */
...
/* localStorage.setItem('bgcolor', document.getElementById('bgcolor').value); */
      ...
      // console.log('typeof cameraAddedTable: ' + typeof cameraAddedTable)
       //console.log(cameraAdded) 
       ...
       console.log(JSON.stringify(cameraAddedTable)) 
       console.log(cameraAddedTable)
      // console.log(localStorage.setItem(cameraAddedTable, JSON.stringify(cameraAddedTable)))
       //console.log('typeof cameraAddedTable: ' + typeof cameraAddedTable)


       //const cameraAddedString = JSON.stringify(cameraAdded)
       //localStorage.setItem(cameraAddedString, cameraAddedString)
       //console.log(cameraAddedString) 
       //console.log('typeof cameraAddedString: ' + typeof cameraAddedString)
